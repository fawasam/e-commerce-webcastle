...
exports.ValidateSignature = exports.GenerateSignature = exports.ValidatePassword = exports.GeneratePassword = exports.GenerateSalt = exports.GenerateOtp = void 0;
var bcryptjs_1 = __importDefault(require("bcryptjs"));
var jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
var config_1 = require("../config");
var GenerateOtp = function () {
    var otp = Math.floor(100000 + Math.random() * 900000);
    var expiry = new Date(Date.now() + 60000);
...
var GenerateSignature = function (payload) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, jsonwebtoken_1.default.sign(payload, config_1.APP_SECRET, { expiresIn: "1d" })];
    });
}); };
